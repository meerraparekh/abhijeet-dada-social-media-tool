...
class ClipSuggestion(BaseModel):
    ...
    hook: str = Field(description="The opening line or moment that makes this clip worth stopping to watch")
    youtube_title: str = Field(description="A YouTube-style title for this clip, under 100 characters")
    instagram_caption: str = Field(description="A ready-to-post Instagram Reel caption, 1-3 sentences")
    twitter_text: str = Field(description="A ready-to-post tweet/X post text to accompany the clip, under 280 characters")
    hashtags: List[str] = Field(description="3-8 relevant hashtags, without the # symbol")
